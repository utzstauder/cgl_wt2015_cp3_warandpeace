...
public class BirdScript_edit : MonoBehaviour {
    ...
    void Update()
    {
        bool jumpJustPressed = m_hftInput.GetButtonDown("fire1");
        // If we're on the ground AND we just pressed jump
    ...
    void FixedUpdate () {
        ...
        float move = m_hftInput.GetAxis("Horizontal");
	...
	void OnCollisionEnter2D(Collision2D other){
		// "die" when hit by drone projectiles
